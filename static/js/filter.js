function updateDate() {
	...
	keyUrl = 'http://whatsmappening.io:5000/api/event-date/' + d + '%20' + getMonthNameFromMonthNumber(m)+ '%20' + y;
...
inputBox.onkeyup = function(e){
	...
	let keyUrl = "http://whatsmappening.io:5000/api/search/"+inputBox.value;
	$.getJSON(keyUrl, function(data){
